...
fun StartScreen(modifier: Modifier = Modifier) {
        ...
        Card(
            ...
            Column {
                Image(painter = painterResource(id = R.drawable.magnitka), contentDescription = null)
                Column(Modifier.padding(dimensionResource(id = R.dimen.padding_medium))) {
                    Text(
                        text = stringResource(id = R.string.magnitogorsk_title),
                        style = MaterialTheme.typography.titleLarge,
                        modifier = Modifier.padding(bottom = dimensionResource(id = R.dimen.padding_small))
                    )
                    Text(
                        text = stringResource(id = R.string.magnitka_description),
