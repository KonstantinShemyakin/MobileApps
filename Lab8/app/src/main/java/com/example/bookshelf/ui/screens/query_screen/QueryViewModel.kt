...
class QueryViewModel(
    private val IBookshelfRepository: IBookshelfRepository
): ViewModel() {
    ...
    fun getBooks(query: String = "") { //  "travel"
        ...
        viewModelScope.launch {
            ...
            _uiState.value = try {
                ...
                val books = IBookshelfRepository.getBooks(query)
                if (books == null) {
                    QueryUiState.Error
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                QueryViewModel(IBookshelfRepository = bookshelfRepository)
            }
        }
    }
}