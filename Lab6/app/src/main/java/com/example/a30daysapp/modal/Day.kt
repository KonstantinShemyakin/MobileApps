...
@Composable
fun Day(id: Int, quote: Quota, modifier: Modifier = Modifier){
    ...
    Card{
        Column (
            ...
            Text(text = "Цитата дня ${id}:",
                style = MaterialTheme.typography.titleSmall)
            Text(
                text = "Джейсон Цитатник Стетхем",
            ...
            Button(onClick = { isDisplayedQuote = !isDisplayedQuote},
                ...
                Text(if (isDisplayedQuote) "Спрятать цитату" else "Показать цитату",
